...
public class Fonts {
   public static CustomTextRenderer google;
   public static CustomTextRenderer googlelittle;
   ...
   public static void loadFonts() throws IOException, FontFormatException {
      ...
      google = new CustomTextRenderer("google",32,0,255,512);
      googlelittle = new CustomTextRenderer("google-regular",32,0,255,2048);
   }
}
