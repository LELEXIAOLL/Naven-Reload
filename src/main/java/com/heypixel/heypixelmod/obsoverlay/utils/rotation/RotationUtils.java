...
public class RotationUtils {
   ...
   public static float rotateToYaw(float speed, float currentYaw, float targetYaw, float step) {
      float difference = net.minecraft.util.Mth.wrapDegrees(targetYaw - currentYaw);
      float change = net.minecraft.util.Mth.clamp(difference * step, -speed, speed);
      return currentYaw + change;
   }
